    ...
    <ul>
		<li>
			<div class="image_title">
				<a href="<?php echo base_url('featured0');?>?=<?php echo $user;?>">Featured Pets</a>
			</div>
			<a href="<?php echo base_url('featured0');?>?=<?php echo $user;?>">
				<img src="<?php echo base_url('assets/img/community1.jpg');?>">
			</a>
		</li>
		<li>
			<div class="image_title">
				<a href="<?php echo base_url('recent0');?>?=<?php echo $user;?>">Recent Posts</a>
			</div>
			<a href="<?php echo base_url('recent0');?>?=<?php echo $user;?>">
				<img src="<?php echo base_url('assets/img/community2.jpg');?>">
			</a>
		</li>
		<li>
			<div class="image_title">
				<a href="<?php echo base_url('itemsales0');?>?=<?php echo $user;?>">Item Sales</a>
			</div>
			<a href="<?php echo base_url('itemsales0');?>?=<?php echo $user;?>">
				<img src="<?php echo base_url('assets/img/community3.jpg');?>">
			</a>
		</li>
		<li>
			<div class="image_title">
				<a href="<?php echo base_url('adoptions0');?>?=<?php echo $user;?>">Adoptions</a>
			</div>
			<a href="<?php echo base_url('adoptions0');?>?=<?php echo $user;?>">
				<img src="<?php echo base_url('assets/img/community4.jpg');?>">
			</a>
		</li>
		<li>
			<div class="image_title">
				<a href="<?php echo base_url('donations0');?>?=<?php echo $user;?>">Donations</a>
			</div>
			<a href="<?php echo base_url('donations0');?>?=<?php echo $user;?>">
