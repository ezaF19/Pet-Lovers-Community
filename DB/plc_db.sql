...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 23, 2018 at 07:10 AM
...
CREATE TABLE `item` (
  ...
  `ItemContact` int(11) NOT NULL,
  `ItemLocation` varchar(255) NOT NULL,
  `ItemPic` longblob NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `account`
  MODIFY `AccountID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `pet`
  MODIFY `PetID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `service`
  MODIFY `ServiceID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
